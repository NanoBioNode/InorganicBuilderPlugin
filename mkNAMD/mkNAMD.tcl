proc mkNAMD { builtPSF builtPDB outDir parDir dimFactor namdFile simFile Temperature Dielectric Damping minimStep simStep setIMD sspVecs} {
set argc 10
set argv {}
...
puts $namdFile "extraBondsFile  constrain/mghh_extrabonds"
puts $namdFile "}"
puts $namdFile ""
